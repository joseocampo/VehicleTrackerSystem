...
/**
 * TIncidents generated by hbm2java
 */
public class TIncidents  implements java.io.Serializable {
    ...
    public TIncidents(Date pkDate, TUserInformation TUserInformation, TVehicle TVehicle, float cost) {
        this.pkDate = pkDate;
        this.TUserInformation = TUserInformation;
        this.TVehicle = TVehicle;
        this.cost = cost;
    }
    public TIncidents(Date pkDate, TUserInformation TUserInformation, TVehicle TVehicle, String details, float cost) {
       this.pkDate = pkDate;
       this.TUserInformation = TUserInformation;
       this.TVehicle = TVehicle;
